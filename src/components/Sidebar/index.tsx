    ...
    return (
        ...
        >
            ...
            <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear ">
                <nav className="flex mt-5 py-4 px-4 lg:mt-9 lg:px-0.5">

                    <div className="flex  w-2 flex-1 flex-col justify-between border-e">
                        {/* <!-- Menu Group --> */}
                        <div>
                            ...
                            <ul className="mb-6 flex flex-col gap-1.5">
                                ...
                                {isAdmin && (
                                    <SidebarLinkGroup
                                    activeCondition={pathname.includes('profile')}
                                >
                                    {(handleClick, open) => (
                                        <React.Fragment>
                                            <NavLink
                                            ...
                                            >
                                                ...
                                                <svg
                                                    ...
                                                    xmlns="http://www.w3.org/2000/svg"
                                                >
                                                    {/* Placeholder SVG Path for dropdown icon */}
